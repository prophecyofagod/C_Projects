//	Mario Saiz
//	Project 1 (Coding Assingment #2)
//	Operating Systems: Professor Gallmeier
//	3/3/2020

//	I tried my best on this assignment, but it was very hard
//	and I couldn't figure out the pipe without messing up
//	my code too much, so I left it how I had it previously.
...
static void run_from_history(const char * cmd){
	...
	if(cmd[1] == '!') 
		...
		if((index < 0) || (index > cmd_history_count)){ 
			fprintf(stderr, "Command is NOT found in history.\n");
				return;
		}
	}
	printf("%s\n", cmd);	
